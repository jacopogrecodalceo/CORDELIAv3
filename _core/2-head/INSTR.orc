...
gScorpia[]			init ginchnls
gScrij[]			init ginchnls
gScril[]			init ginchnls
...
until	indx == ginchnls do
	...
	gScorpia[indx]			sprintf	"corpia_%i", indx+1
	gScrij[indx]			sprintf	"crij_%i", indx+1
	gScril[indx]			sprintf	"cril_%i", indx+1
	...
	gSetag2[indx]			sprintf	"etag2_%i", indx+1
	...
	gSfairest3[indx]			sprintf	"fairest3_%i", indx+1
	gSfairest4[indx]			sprintf	"fairest4_%i", indx+1
	...
	gSgesto1var[indx]			sprintf	"gesto1var_%i", indx+1
	...
	gSmaison[indx]			sprintf	"maison_%i", indx+1
	...
	gSmetal[indx]			sprintf	"metal_%i", indx+1
	...
	gSnasa[indx]			sprintf	"nasa_%i", indx+1
	...
	gSpucky[indx]			sprintf	"pucky_%i", indx+1
	gSpur[indx]			sprintf	"pur_%i", indx+1
	...
	gSventre[indx]			sprintf	"ventre_%i", indx+1
	...
	gSwitches2[indx]			sprintf	"witches2_%i", indx+1
